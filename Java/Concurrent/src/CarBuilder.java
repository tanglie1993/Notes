...
class Car {
    ...
    private boolean
            engine = false, driveTrain = false, wheels = false, bumper = false;
    ...
    public synchronized void addBumper() { bumper = true; }
...
class BumperRobot extends Robot {
    public BumperRobot(RobotPool pool) { super(pool); }
    protected void performService() {
        System.out.println(this + " installing Bumpers");
